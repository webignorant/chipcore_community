...
if($_POST['upload']=="上传")
{
	...
	*/
	...
	{ 
		...
		{ 
			case 1: $showinfo .= '文件大小超过服务器限制'; showinfo($showinfo);
			break; 
			case 2: $showinfo .= '文件太大！'; showinfo($showinfo);
			break; 
			case 3: $showinfo .= '文件只加载了一部分！'; showinfo($showinfo);
			break; 
			case 4: $showinfo .= '文件加载失败！'; showinfo($showinfo);
			break; 
		} 
		showinfo($showinfo);
	} 
