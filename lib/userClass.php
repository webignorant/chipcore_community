...
class userClass extends mysqlClass
{
	...
	*/
	...
	//更新用户个人信息
	function updateUserInfo($userID,$nickName,$password,$photo,$priateSet,$realName,$sex,$birthday,$bloodType,$about,$status,$locaotion,$homeCity,$email,$qq,$MSN,$companyName,$departmentName,$enterTime,$leaveTime,$schoolType,$schoolName,$grade,$classes,$enterTime,$leaveTime)
	{
		$value=array("nickName"=>$nickName,"password"=>$password,"photo"=>$photo,"priateSet"=>$priateSet,
